...
% 是否用手動方式產生文獻 Y: 是 N: 否
% 需自行到 back/references.tex 繕打參考文獻列表
% 選擇「是」將忽略 \thesisSplitRefByLang 在輸出參考文獻時的效果
% \newcommand{\thesisAddRefByManual}{Y}
\newcommand{\thesisAddRefByManual}{N}

% 是否區分中英文獻 Y: 是 N: 否
% 若要使用此選項，則 references.bib 中的文獻需要輸出 langid 欄位
% 中文文獻需要確實設定 langid={zh}
% langid 可從 zh、chinese、 chinese-traditional 中三選一，不能複選
...
\newcommand{\thesisDateROC}{中華民國\zhdigits{\thesisYearROC}年\zhnumber{\thesisMonth}月}
